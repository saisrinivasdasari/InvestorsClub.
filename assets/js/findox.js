(function ($) {
  ...
  // window load and preloader dismissal
  function hidePreloader() {
    if ($(".preloader").length) {
      $(".preloader").addClass("loaded").fadeOut(400);
    }
  }
  ...
  // Fail-safe preloader dismissal (guarantees preloader never hangs if external resource is delayed)
